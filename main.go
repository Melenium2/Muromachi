...
// Сделать штуку которая позволит лимитировать реквесты
// Вместо папки моделей, создать папку с entities и создать отдельные файлы
//	для каждого
// Попробывать создать отдельные папки для каждого repo чтоб не хранить все в одном
//	package
